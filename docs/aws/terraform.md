Here is the complete set of instructions for deploying an EC2 instance with Terraform, attaching default AWS-managed IAM roles, SSH-ing into the instance, and troubleshooting common SSH access issues.
